...
from sample.service.data.data_set import DataSet
from sample.service.data.folder import Folder
from sample.service.utils.folder_helper import FolderHelper
from sample.service.utils.general_processor import GeneralProcessor
...
class Partitioner(object):
    ...
    def generate_data_set(path_ds, file_max_size_bytes, tuples_folders):
        """  This method calls a helper to create file chunks.In addition, Serializes the df information using json
             to disk. The ds information does not contain the bytes information
